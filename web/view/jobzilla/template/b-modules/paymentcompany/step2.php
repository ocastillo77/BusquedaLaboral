      ...
      <div class="col-md-6">
        ...
        <div class="input-group">
          <span class="input-group-addon min-width">
            ...
            <span class="input-text">CUIT</span>
          </span>
          <input type="text" class="form-control" placeholder="CUIT" readonly="true" value="<?php echo isset($rUser['CUIT']) ? $rUser['CUIT'] : ''; ?>">
        </div><!-- End .input-group -->
        <div class="input-group">
          <span class="input-group-addon min-width">
            <span class="input-icon input-icon-user"></span>
            <span class="input-text">Razón Social</span>
          </span>
          <input type="text" class="form-control" placeholder="Razón Social" readonly="true" value="<?php echo isset($rUser['Nombre']) ? $rUser['Nombre'] : ''; ?>">
        </div><!-- End .input-group -->
        <div class="input-group">
          <span class="input-group-addon min-width">
        ...
        <div class="input-group">
          <span class="input-group-addon min-width">
            ...
            <span class="input-text">Teléfono</span>
          </span>
          <input type="text" class="form-control" placeholder="Teléfono" readonly="true" value="<?php echo isset($rUser['Telefono']) ? $rUser['Telefono'] : $item['Telefono']; ?>">
        </div><!-- End .input-group -->
        <div class="input-group">
          <span class="input-group-addon min-width">
