...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p>¡Hola [NAME],</p>
            <p>Gracias por registrarte en <strong><?php echo $sitename; ?></strong>. Por favor, confirma tu dirección de correo electrónico para activar tu cuenta.</p>
            <p>Haz clic en el siguiente enlace para verificar tu correo electrónico:</p>
            <div class="text-center">
                <a href="[LINK_CONFIRMATION]" class="btn" style="color: #fff;">Confirmar Correo Electrónico</a>
            </div>
