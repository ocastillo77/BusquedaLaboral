<!-- OUR BLOG START -->
<div class="section-full p-t120 p-b90 site-bg-white section-pad">
  <div class="row">
    ...
    <div class="col-lg-9 col-md-12 bg-fucsia p-t30 p-b30 p-l50 p-r50">
      <!--Filter Short By-->
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-12 m-b30">
          ...
          <div class="twm-jobs-grid-style1">
            <div class="twm-media">
              <img src="<?php echo URL_IMG; ?>jobs-company/pic1.jpg" alt="#">
            </div>
        ...
        <div class="col-lg-4 col-md-12 m-b30">
          ...
          <div class="twm-jobs-grid-style1">
            <div class="twm-media">
              <img src="<?php echo URL_IMG; ?>jobs-company/pic2.jpg" alt="#">
            </div>
        ...
        <div class="col-lg-4 col-md-12 m-b30">
          ...
          <div class="twm-jobs-grid-style1">
            <div class="twm-media">
              <img src="<?php echo URL_IMG; ?>jobs-company/pic3.jpg" alt="#">
            </div>
        ...
        <div class="col-lg-4 col-md-12 m-b30">
          ...
          <div class="twm-jobs-grid-style1">
            <div class="twm-media">
              <img src="<?php echo URL_IMG; ?>jobs-company/pic4.jpg" alt="#">
            </div>
        ...
        <div class="masonry-item col-lg-4 col-md-12 m-b30">
          ...
          <div class="twm-jobs-grid-style1">
            <div class="twm-media">
              <img src="<?php echo URL_IMG; ?>jobs-company/pic5.jpg" alt="#">
            </div>
            <span class="twm-job-post-duration">1 days ago</span>
