                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <div class="ls-inputicon-box">
                              <input class="form-control" id="dni" type="text" placeholder="DNI" value="<?php echo isset($rUser['DNI']) ? $rUser['DNI'] : ''; ?>" required readonly="true">
                            </div>
                          </div>
                          <div class="form-group">
                            <label>Nombre y Apellido</label>
                            <div class="ls-inputicon-box">
                              <input class="form-control" id="nombre" type="text" placeholder="Nombre y Apellido" value="<?php echo isset($rUser['Nombre']) ? $rUser['Nombre'] : ''; ?>" required readonly="true">
                            </div>
                          </div>
                          <div class="form-group">
                            <label>Email</label>
                          ...
                          <div class="form-group">
                            <label>Celular</label>
                            <div class="ls-inputicon-box">
                              <input class="form-control" id="celular" name="usuarios[Celular]" type="text" placeholder="Celular" value="<?php echo isset($rUser['Celular']) ? $rUser['Celular'] : ''; ?>" required>
                            </div>
                          </div>
                          <div class="form-group">
