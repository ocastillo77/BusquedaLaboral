      ...
      <div class="col-md-6">
        ...
        <div class="input-group">
          ...
          <input type="text" class="form-control" placeholder="Celular" 
                 readonly="true"
                 value="<?php echo isset($rUser['Celular']) ? $rUser['Celular'] : $item['Celular']; ?>">
        </div><!-- End .input-group -->
        <div class="input-group">
          <span class="input-group-addon min-width">
          ...
          <input type="text" class="form-control" placeholder="Código Postal"
                 id="cpostalPrev" readonly="true"
                 value="<?php echo isset($rUser['CPostal']) ? $rUser['CPostal'] : $item['CPostal']; ?>">
        </div><!-- End .input-group -->
      ...
      <div class="col-md-6">
        ...
        <div class="input-group">
          ...
          <input type="text" class="form-control" placeholder="Dirección"
                 id="direccionPrev" readonly="true"
                 value="<?php echo isset($rUser['Direccion']) ? $rUser['Direccion'] : ''; ?>">
        </div><!-- End .input-group -->                        
        <div class="input-group">
          <span class="input-group-addon min-width">
          ...
          <input type="text" class="form-control" placeholder="Localidad"
                 id="localidadPrev" readonly="true"
                 value="<?php echo isset($rUser['Localidad']) ? $rUser['Localidad'] : ''; ?>">
        </div><!-- End .input-group -->                        
        <div class="input-group">
          <span class="input-group-addon min-width">
