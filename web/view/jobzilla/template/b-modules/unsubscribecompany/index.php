<?php
$urlAccount = URL_WEB . 'accountCompany';
$urlUnsubscribe = URL_WEB . 'unsubscribeSubmitCompany';
?>
          ...
          <div class="twm-right-section-panel bg-secondary m-t30">
            ...
            <div class="panel panel-default">
              <div class="panel-heading wt-panel-heading p-a20 p-t30">
                ...
                <p class="text-center">
                  Hola <b><?php echo Session::get('em_name'); ?></b>, ¿estás seguro de que quieres dar de baja tu plan actual?<br>
