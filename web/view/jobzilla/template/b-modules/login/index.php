          ...
          <div class="twm-log-reg-inner">
            ...
            <div class="twm-tabs-style-2">
              <ul class="nav nav-tabs" id="myTab2" role="tablist">
                <!--Login Candidate-->
                <li class="nav-item">
                  <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#twm-login-candidate" type="button"><i class="fas fa-user-tie"></i>Candidatos</button>
                </li>
                <!--Login Employer-->
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#twm-login-Employer" type="button"><i class="fas fa-building"></i>Empresas</button>
                </li>
              </ul>
                      ...
                      <div class="col-lg-12">
                        <div class="form-group mb-3">
                          <div class="password-container">
                            <input type="password" class="form-control password" id="wb_password" name="wb_password" placeholder="Contraseña" required>
                  ...
                  <form id="form-loginE" method="post" action="<?php echo $urlLoginCompany; ?>">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-12">
                        <div class="form-group mb-3">
                          <div class="password-container">
                            <input type="password" class="form-control passwordE" id="em_password" name="em_password" placeholder="Contraseña" required>
