                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <div class="ls-inputicon-box">
                              <input class="form-control" id="cuit" name="empresas[CUIT]" type="text" placeholder="CUIT" value="<?php echo isset($rUser['CUIT']) ? $rUser['CUIT'] : ''; ?>" required readonly="true">
                            </div>
                          </div>
                          <div class="form-group">
                            <label>Razón Social</label>
                            <div class="ls-inputicon-box">
                              <input class="form-control" id="nombre" name="empresas[Nombre]" type="text" placeholder="Razón Social" value="<?php echo isset($rUser['Nombre']) ? $rUser['Nombre'] : ''; ?>" required readonly="true">
                            </div>
                          </div>
                          <div class="form-group">
                            <label>Email</label>
                            <div class="ls-inputicon-box">
                              <input class="form-control" id="email" name="empresas[Email]" type="text" placeholder="Email" value="<?php echo isset($rUser['Email']) ? $rUser['Email'] : ''; ?>" required readonly="true">
                            </div>
                          </div>
                          <div class="form-group">
                            <label>Teléfono</label>
                            <div class="ls-inputicon-box">
                              <input class="form-control" id="telefono" name="empresas[Telefono]" type="text" placeholder="Teléfono" value="<?php echo isset($rUser['Telefono']) ? $rUser['Telefono'] : ''; ?>" required readonly="true">
                            </div>
                          </div>
                          <div class="form-group">
