...
<?php
$totalPost = count($data['jobs']);
$totalTest = count($data['tests']);
?>
                ...
                <div class="panel panel-default">
                    <div class="panel-body wt-panel-body dashboard-card-2 block-gradient">
                        <div class="wt-card-wrap-2">
                            ...
                            <div class="wt-card-right wt-total-active-listing counter "><?php echo $totalPost; ?></div>
                            <div class="wt-card-bottom-2 ">
                                <h4 class="m-b0">Postulaciones</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body wt-panel-body dashboard-card-2 block-gradient-2">
                        <div class="wt-card-wrap-2">
                            ...
                            <div class="wt-card-right  wt-total-listing-view counter "><?php echo $totalTest; ?></div>
                            <div class="wt-card-bottom-2">
                                <h4 class="m-b0">Mis Tests</h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
                <div class="panel panel-default">
                    <div class="panel-heading wt-panel-heading p-a20">
                        <h4 class="panel-tittle m-a0">Postulaciones Recientes</h4>
                    </div>
                            ...
                            <div class="row">
                                ...
                                if (!empty($data['jobs'])) :
                                    foreach ($data['jobs'] as $item) :
                                        $imagen = !empty($data['Imagen']) ? URL_GAL . 'postulaciones/images/IM_' . $data['Imagen'] : '';
                                ?>
