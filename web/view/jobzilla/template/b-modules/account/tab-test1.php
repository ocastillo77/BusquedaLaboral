    ...
    <div class="twm-dashboard-candidates-wrap">
            ...
            <select id="grupofamiliar" name="<?php echo $tabla; ?>[GrupoFamiliar]" onchange="changeGrupo(this.value);" class="form-select">
                ...
                if (!empty($data['grupos'])) :
                    foreach ($data['grupos'] as $value) :
                        $selected = !empty($item['GrupoFamiliar']) && $item['GrupoFamiliar'] == $value['ID'] ? 'selected="selected"' : '';
                ?>
        ...
        <div class="mb-3">
            ...
            <select id="disponibilidad" name="<?php echo $tabla; ?>[Disponibilidad]" onchange="changeDispo(this.value)" class="form-select">
                ...
                if (!empty($data['dispos'])) :
                    foreach ($data['dispos'] as $value) :
                        $selected = !empty($item['Disponibilidad']) && $item['Disponibilidad'] == $value['ID'] ? 'selected="selected"' : '';
                ?>
                        <option value="<?php echo $value['ID']; ?>" <?php echo $selected; ?>><?php echo $value['Nombre']; ?></option>
                <?php
                    endforeach;
            ...
            <select id="niveledu" name="<?php echo $tabla; ?>[NivelEdu]" class="form-select">
                ...
                if (!empty($data['niveles'])) :
                    foreach ($data['niveles'] as $value) :
                        $selected = !empty($item['NivelEdu']) && $item['NivelEdu'] == $value['ID'] ? 'selected="selected"' : '';
                ?>
                        <option value="<?php echo $value['ID']; ?>" <?php echo $selected; ?>><?php echo $value['Nombre']; ?></option>
                <?php
                    endforeach;
        ...
        <div class="mb-3">
            ...
            <select id="trabajos" name="<?php echo $tabla; ?>[AreaL]" class="form-select">
                ...
                if (!empty($data['trabajos'])) :
                    foreach ($data['trabajos'] as $value) :
                        $selected = !empty($item['AreaL']) && $item['AreaL'] == $value['ID'] ? 'selected="selected"' : '';
                ?>
                        <option value="<?php echo $value['ID']; ?>" <?php echo $selected; ?>><?php echo $value['Nombre']; ?></option>
                <?php
                    endforeach;
        ...
        <div class="mb-4">
            ...
            <select id="nivelinfor" name="<?php echo $tabla; ?>[NivelInfor]" class="form-select">
                <?php
                if (!empty($data['informatico'])) :
                    foreach ($data['informatico'] as $value) :
                        $selected = !empty($item['NivelInfor']) && $item['NivelInfor'] == $value['ID'] ? 'selected="selected"' : '';
                ?>
                        <option value="<?php echo $value['ID']; ?>" <?php echo $selected; ?>><?php echo $value['Nombre']; ?></option>
                <?php
                    endforeach;
