          ...
          <div class="twm-right-section-panel site-bg-primary">
            ...
            <div class="panel panel-default">
              <div class="panel-heading wt-panel-heading p-a20 p-t30">
                <h3 class="panel-tittle m-b30 text-center">Recuperar Contraseña</h3>
              ...
              <div class="panel-body wt-panel-body p-a20 ">
                <form id="form-recover" class="form-ajax" method="post" action="<?php echo $urlform; ?>">
                  <input type="hidden" id="recover" name="recover" value="1" />
                  <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12">
                      <div class="form-group">
                        <label>Correo Electrónico</label>
                        <div class="ls-inputicon-box">
                          <input class="form-control" id="email" name="email" type="email" placeholder="john@example.com">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12">
                      <div class="text-center">Volver a iniciar sesión <a href="<?php echo URL_WEB . 'login'; ?>" class="text-uppercase">aquí</a></div>
                    </div>
                  </div>
                </form>
              </div>
