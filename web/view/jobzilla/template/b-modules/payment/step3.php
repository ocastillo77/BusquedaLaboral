    ...
    <div class="row factura">
      <div class="col-md-6">
        ...
        <div class="input-group">
          ...
          <input type="text" required class="form-control" placeholder="DNI" readonly="true" value="<?php echo isset($rUser['DNI']) ? $rUser['DNI'] : ''; ?>">
        </div><!-- End .input-group -->
        <div class="input-group">
          <span class="input-group-addon min-width">
            <span class="input-icon input-icon-user"></span>
          ...
          <input type="text" required class="form-control" placeholder="Nombre y Apellido" readonly="true" value="<?php echo isset($rUser['Nombre']) ? $rUser['Nombre'] : ''; ?>">
        </div><!-- End .input-group -->
        <div class="input-group">
          <span class="input-group-addon min-width">
          ...
          <input type="text" required class="form-control" placeholder="Correo Electrónico" readonly="true" value="<?php echo isset($rUser['Email']) ? $rUser['Email'] : ''; ?>">
        </div><!-- End .input-group -->
        <div class="input-group">
          <span class="input-group-addon min-width">
          ...
          <input type="text" required class="form-control" placeholder="Celular" readonly="true" value="<?php echo isset($rUser['Celular']) ? $rUser['Celular'] : ''; ?>">
        </div><!-- End .input-group -->
        <div class="input-group">
          <span class="input-group-addon min-width">
          ...
          <input type="text" class="form-control" placeholder="Código Postal" readonly="true" value="<?php echo isset($rUser['CPostal']) && $data['dirsend'] == 1 ? $rUser['CPostal'] : (isset($post['CPostal']) ? $post['CPostal'] : ''); ?>">
        </div><!-- End .input-group -->
      ...
      <div class="col-md-6">
        ...
        <div class="input-group">
          ...
          <input type="text" class="form-control" placeholder="Dirección" readonly="true" value="<?php echo isset($rUser['Direccion']) && $data['dirsend'] == 1 ? $rUser['Direccion'] : (isset($post['Direccion']) ? $post['Direccion'] : ''); ?>">
        </div><!-- End .input-group -->
        <div class="input-group">
          <span class="input-group-addon min-width">
            <span class="input-icon input-icon-city"></span>
            <span class="input-text">Localidad</span></span>
          <input type="text" required class="form-control" placeholder="Localidad" readonly="true" value="<?php echo isset($rUser['Localidad']) && $data['dirsend'] == 1 ? $rUser['Localidad'] : (isset($post['Localidad']) ? $post['Localidad'] : ''); ?>">
        </div><!-- End .input-group -->
        <div class="input-group">
          <span class="input-group-addon min-width">
