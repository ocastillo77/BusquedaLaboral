              ...
              <div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionSubs">
                <div class="accordion-body">
                  <div class="panel-body">
                    ...
                    <?php endif; ?>
                    <form id="form-billing" method="post" action="<?php echo URL_WEB . 'billing'; ?>">
                      <input type="hidden" id="billing" name="billing" value="1" />
                      <div class="row factura">
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <div class="ls-inputicon-box">
                              <input class="form-control" id="dni" name="usuarios[DNI]" type="text" placeholder="DNI" value="<?php echo isset($rUser['DNI']) ? $rUser['DNI'] : ''; ?>" required readonly="true">
                            </div>
                          </div>
                          <div class="form-group">
                            <label>Nombre y Apellido</label>
                            <div class="ls-inputicon-box">
                              <input class="form-control" id="nombre" name="usuarios[Nombre]" type="text" placeholder="Nombre y Apellido" value="<?php echo isset($rUser['Nombre']) ? $rUser['Nombre'] : ''; ?>" required readonly="true">
                            </div>
                          </div>
                          <div class="form-group">
                            <label>Email</label>
                            <div class="ls-inputicon-box">
                              <input class="form-control" id="email" name="usuarios[Email]" type="text" placeholder="Email" value="<?php echo isset($rUser['Email']) ? $rUser['Email'] : ''; ?>" required readonly="true">
                            </div>
                          </div>
                          <div class="form-group">
                            <label>Celular</label>
                            <div class="ls-inputicon-box">
                              <input class="form-control" id="celular" name="usuarios[Celular]" type="text" placeholder="Celular" value="<?php echo isset($rUser['Celular']) ? $rUser['Celular'] : ''; ?>" required readonly="true">
                            </div>
                          </div>
                          <div class="form-group">
                            <label>Código Postal</label>
                            <div class="ls-inputicon-box">
                              <input class="form-control" id="cpostal" name="usuarios[CPostal]" type="text" placeholder="Código Postal" value="<?php echo isset($rUser['CPostal']) ? $rUser['CPostal'] : ''; ?>" required>
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <div class="ls-inputicon-box">
                              <input class="form-control" id="direccion" name="usuarios[Direccion]" type="text" placeholder="Dirección" value="<?php echo isset($rUser['Direccion']) ? $rUser['Direccion'] : ''; ?>" required>
                          ...
                          <div class="form-group">
                            ...
                            <div class="ls-inputicon-box">
                              <input class="form-control" id="localidad" name="usuarios[Localidad]" type="text" placeholder="Localidad" value="<?php echo isset($rUser['Localidad']) ? $rUser['Localidad'] : ''; ?>" required>
