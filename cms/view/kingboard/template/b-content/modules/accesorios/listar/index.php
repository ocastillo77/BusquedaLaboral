    ...
    <table class="table table-bordered table-striped" id="list-table">
      <thead>
        <tr class="odd">
          ...
          endforeach;
          ?>
          <th width="150" class="nosort center" data-align="center">Acción</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td colspan="<?php echo count($data['heads']) + 1; ?>" class="dataTables_empty">Cargando datos del Servidor...</td>
        </tr>
      </tbody>
    </table>
  <?php endif; ?>
