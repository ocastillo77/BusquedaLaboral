                ...
                <div class="col-md-8">
                  <form id="form-filter" method="post" class="row">
                    <div class="form-group col-md-3">
                      <label class="inline">Accesorios:</label>
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <select id="condicion" name="categoria" data-rel="chosen" class="inline">   
                        <option value="">- Todos -</option>    
                        <?php
...
<script>
  var aUrlFilter = "<?php echo URL_CMS . $data['base_url'] . 'filter/' . $data['type'] . '/' . $data['categoria']; ?>";
