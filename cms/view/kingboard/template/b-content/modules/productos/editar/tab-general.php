...
<div class="col-md-4">
  <div class="widget-content">
    <div class="form-group">
      <label class="control-label">&iquest;Es Producto Destacado?</label>
      <div class="controls">
        <?php
    ...
    <div class="form-group">
      ...
      <div class="controls">
        <input type="text" class="form-control" name="<?php echo $tabla; ?>[Stock]" value="<?php echo (isset($data[$tabla]['Stock'])) ? $data[$tabla]['Stock'] : ''; ?>" />
      </div>
    </div>
    <div class="form-group">
