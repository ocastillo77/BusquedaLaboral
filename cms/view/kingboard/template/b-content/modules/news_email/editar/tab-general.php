    ...
    <div class="widget">
      ...
      <div class="widget-content">
        ...
        <div class="form-group">
          <label class="control-label"><span class="obligatory">*</span> Nombre:</label>
          <div class="controls">
        ...
        <div class="form-group">
          <label class="control-label"><span class="obligatory">*</span> Email:</label>
          <div class="controls">
            <input type="email" class="form-control" id="email" name="<?php echo $tabla; ?>[Email]" value="<?php if (isset($data[$tabla]['Email'])) echo $data[$tabla]['Email']; ?>" />
            <p class="help-block"></p>
          </div>
        </div>        
        <div class="cont-hint">
    ...
    <div class="widget">
      ...
      <div class="widget-content">        
        <div class="form-group">
          ...
          <div class="controls">
            <select id="categorias" name="<?php echo $tabla; ?>[GroupID]" data-rel="chosen">
              <?php
              if (isset($data['categorias'])) :
                foreach ($data['categorias'] as $item):
                  $selected = $data[$tabla]['GroupID'] == $item['ID'] ? 'selected="selected"' : '';
                  ?>
