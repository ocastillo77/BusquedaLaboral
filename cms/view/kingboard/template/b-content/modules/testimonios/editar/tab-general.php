  ...
  <div class="widget">
    ...
    <div class="widget-content">
      ...
      <div class="form-group">
        ...
        <div class="controls">
          <textarea id="sumario" name="<?php echo $tabla; ?>[Sumario]" class="form-control" rows="3"><?php if (isset($data[$tabla]['Sumario'])) echo $data[$tabla]['Sumario']; ?></textarea>
          <p class="help-block"></p>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="controls">
          <textarea id="comentario" name="<?php echo $tabla; ?>[Comentario]" class="full-editor form-control" rows="5"><?php if (isset($data[$tabla]['Comentario'])) echo $data[$tabla]['Comentario']; ?></textarea>
          <p class="help-block"></p>
        </div>
      </div>
      <div class="cont-hint">
  ...
  <div class="widget">
    ...
    <div class="widget-content">
      <div class="form-group">
        ...
        <div class="controls">
          <input type="text" class="form-control" id="cargo" name="<?php echo $tabla; ?>[Cargo]" value="<?php if (isset($data[$tabla]['Cargo'])) echo $data[$tabla]['Cargo']; ?>" />
          <p class="help-block"></p>
        </div>
      </div>
      <div class="form-group">
