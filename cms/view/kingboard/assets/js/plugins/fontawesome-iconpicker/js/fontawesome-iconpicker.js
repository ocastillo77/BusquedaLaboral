...
(function (a) {
  ...
  c.defaultOptions = {
    ...
    templates: {
      ...
      buttons: '<button class="iconpicker-btn iconpicker-btn-cancel btn btn-default btn-sm">Cancelar</button>' + ' <button class="iconpicker-btn iconpicker-btn-accept btn btn-primary btn-sm">Aceptar</button>',
