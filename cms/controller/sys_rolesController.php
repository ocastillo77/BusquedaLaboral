...
class sys_rolesController extends Controller {
  ...
  public function listar() {
    ...
    if (Validate::integer('listar', true) == 1) {
      ...
      $ids = $_POST['selected'];
      $opt == 4 ? $this->model->deleteGrupos($ids) : $this->model->updateGrupos($opt, $ids);
    }
  ...
  public function editar($id) {
    ...
    $data[$this->tabla] = $this->model->getGrupo($id);
    $this->view->assign('data', $data);
    $this->view->render();
  }
