...
class cateprodController extends Controller {
  ...
  public function listar() {
    ...
    if (Validate::integer('listar', true) == 1) {
      ...
      $ids = $_POST['selected'];
      $opt == 4 ? $this->model->deleteCateProds($ids) : $this->model->updateCateProds($opt, $ids);
    }
  ...
  public function insertar() {
    ...
    if (Validate::integer('actualizar', true) == 1) {
      ...
      $this->model->updateCateProd($fields);
  ...
  public function editar($id) {
    ...
    $data[$this->tabla] = $this->model->getCateProd($id);
    $data['categorias'] = $this->model->getCategorias($id);
    $data['selectpos'] = $this->model->getSelectPos();
  ...
  public function setRowsExtra($key = '', $value = null) {
    switch ($key) {
      ...
      case 'ID':
        ...
        break;
      case 'FilialID':
        $row = !empty($value) ? $this->model->getFilialesCat($value) : 'No Asignada';
        break;
      case 'Publico':
