...
class estadisticasController extends Controller
{
  ...
  public function headers()
  {
    ...
    $headers['Titulo'] = ['title' => 'Título', 'sort' => 'sisort', 'align' => 'center'];
    $headers['Cantidad'] = ['title' => 'Cantidad', 'sort' => 'sisort', 'align' => 'center'];
  ...
  public function insertar()
  {
    ...
    $data['tabla'] = $this->tabla;
    $data['base_url'] = $this->baseUrl;
    $data['th_width'] = $this->thAncho;
    $data['th_height'] = $this->thAlto;
  ...
  {
    echo $this->uploadImage($_FILES['userfile'], $this->thAncho, $this->thAlto, $this->thAncho, $this->thAlto);
  }
